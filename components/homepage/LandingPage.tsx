 ...
 *
 * Client-side homepage with acquisition tracking
 */
...
import { trackLandingView } from '@/lib/analytics/acquisition';
        ...
        <section className="container mx-auto px-6 py-24 text-center">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="mt-6 text-lg text-muted-foreground">
              VelloPad is the modern book creation studio. Write with AI-powered
              prompts, design with professional templates, and order print
              copies—all in one place.
            </p>
            <div className="mt-10 flex items-center justify-center gap-4">
              <Button size="lg" asChild>
                <TrackedLink
                  ...
                  ctaLocation="hero"
                  trackingProperties={{ is_primary: true }}
                >
                  Start Your Book
                </TrackedLink>
              </Button>
              <Button size="lg" variant="outline" asChild>
                <TrackedLink
                  ...
                  ctaLabel="Learn More"
                  ctaLocation="hero"
                  trackingProperties={{ is_primary: false }}
                >
                  Learn More
                </TrackedLink>
              </Button>
